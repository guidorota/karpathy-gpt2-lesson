...
class DataLoaderLite:
    ...
    def next_batch(self):
        ...
        # load next shard if out of bounds
...
train_loader = DataLoaderLite(B=B, T=T, device=device, process_rank=ddp_rank, num_processes=ddp_world_size, split="train")
val_loader = DataLoaderLite(B=B, T=T, device=device, process_rank=ddp_rank, num_processes=ddp_world_size, split="val")
...
for step in range(max_steps):
    ...
    if step % 250 == 0 or last_step:
        ...
        if master_process:
            ...
            if step > 0 and (step % 5000 == 0 or last_step):
                ...
                # optimizer.state_dict() and rng seeds missing, need to be added if we want
                # to use this checkpoint to resume training
    ...
    # Generate samples to validate training is happening
